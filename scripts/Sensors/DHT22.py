...
PORT = 1883
CLIENT_ID = "DHT22_Sensor_01"
TEMP_TOPIC = "/sensor/temperature"
HUMIDITY_TOPIC = "/sensor/humidity"

# Set GPIO pin for the DHT22 sensor (using board.D24)
DHT_PIN = board.D24  # GPIO pin where the data pin of the DHT22 is connected
...
# Initialize DHT22 sensor using board.D24 for the GPIO pin
...
try:
    while True:
        read_DHT22_data()  # Read data from the DHT22 sensor
